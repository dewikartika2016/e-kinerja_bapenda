<?php 
	...
	if (isset($_POST['simpan'])) {
		...
		$sql = "insert into skp_tahunan values(null, '$tahun', '$kegiatan_tahunan', '$target_kuantitas', '$satuan_kuantitas', 100, '$target_waktu', '$periode_awal', '$periode_akhir', '$biaya', 'Belum Disetujui')";
    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <span class="pull-right"><a class="btn btn-danger" href="detail_index.php?p=skptahunan" role="button"><span class="fa fa-arrow-circle-o-left"></span> Kembali</a></span>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
